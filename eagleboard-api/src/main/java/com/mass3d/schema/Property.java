...
public class Property implements Ordered, Klass
{
     ...
     *
     * @see com.mass3d.common.annotation.Description
     */
    ...
    {
        return Objects
            .hash( klass, propertyType, itemKlass, itemPropertyType, getterMethod, setterMethod, name, fieldName, persisted, collectionName,
