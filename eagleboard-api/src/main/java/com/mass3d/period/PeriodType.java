    ...
    implements Serializable
{
    ...
    private static final Map<String, PeriodType> PERIOD_TYPE_MAP = Maps
        .uniqueIndex( PERIOD_TYPES, pt -> pt.getName() );
     ...
     */
    public static List<Period> getPeriodTypePeriods( Period period, com.mass3d.calendar.Calendar calendar )
    {
    ...
    protected Period toIsoPeriod( DateTimeUnit start, DateTimeUnit end, com.mass3d.calendar.Calendar calendar )
    {
    ...
    public abstract Period createPeriod( DateTimeUnit dateTimeUnit, com.mass3d.calendar.Calendar calendar );
     ...
     * @return an instance of a Calendar without any time of day.
     */
    public static DateTimeUnit createLocalDateUnitInstance( Date date, com.mass3d.calendar.Calendar calendar )
    {
     ...
     * @return the period as string
     */
    public abstract String getIsoDate( DateTimeUnit dateTimeUnit, com.mass3d.calendar.Calendar calendar );
     ...
     */
    protected abstract DateTimeUnit getDateWithOffset( DateTimeUnit dateTimeUnit, int offset, com.mass3d.calendar.Calendar calendar );
