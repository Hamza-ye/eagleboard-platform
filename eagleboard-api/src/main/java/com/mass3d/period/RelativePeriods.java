    ...
    implements Serializable
{
    ...
    // Generates an array containing Strings "bimonth1" -> "bimonth6"
    public static final String[] BIMONTHS_THIS_YEAR = streamToStringArray( IntStream
        .rangeClosed( 1, 6 ).boxed(), "bimonth", "" );

    // Generates an array containing Strings "quarter1" -> "quarter4"
    public static final String[] QUARTERS_THIS_YEAR = streamToStringArray( IntStream
        .rangeClosed( 1, 4 ).boxed(), "quarter", "" );
    ...
    public static final String[] QUARTERS_LAST_YEAR = streamToStringArray( IntStream
        .rangeClosed( 1, 4 ).boxed(), "quarter", "_last_year" );
