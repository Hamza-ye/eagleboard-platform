...
import static com.mass3d.common.OrganisationUnitSelectionMode.ACCESSIBLE;
import static com.mass3d.common.OrganisationUnitSelectionMode.ALL;
import static com.mass3d.common.OrganisationUnitSelectionMode.CAPTURE;
import static com.mass3d.common.OrganisationUnitSelectionMode.CHILDREN;
import static com.mass3d.common.OrganisationUnitSelectionMode.DESCENDANTS;
import static com.mass3d.common.OrganisationUnitSelectionMode.SELECTED;
...
import static com.mass3d.trackedentity.TrackedEntityInstanceQueryParams.META_DATA_NAMES_KEY;
...
import static com.mass3d.trackedentity.TrackedEntityInstanceQueryParams.PAGER_META_KEY;
...
import com.mass3d.trackedentityattributevalue.TrackedEntityAttributeValueAuditService;
...
@Slf4j
@Service( "com.mass3d.trackedentity.TrackedEntityInstanceService" )
    ...
    implements TrackedEntityInstanceService
{
        ...
        throws IllegalQueryException
    {
        ...
        {
            List<String> uniqeAttributeIds = attributeService.getAllSystemWideUniqueTrackedEntityAttributes().stream().map( TrackedEntityAttribute::getUid ).collect( Collectors
                .toList() );
        ...
        if ( !isLocalSearch( params, user ) )
        {
            ...
            if ( params.hasAttributesOrFilters() )
            {
                ...
                if ( !params.hasProgram() && !params.hasTrackedEntityType() )
                {
                    searchableAttributeIds.addAll( attributeService.getAllSystemWideUniqueTrackedEntityAttributes().stream().map( TrackedEntityAttribute::getUid ).collect( Collectors
                        .toList() ) );
                }
