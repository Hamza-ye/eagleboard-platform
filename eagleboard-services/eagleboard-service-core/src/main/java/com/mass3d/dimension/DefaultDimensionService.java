...
//    private final OrganisationUnitService organisationUnitService;
  ...
  public DefaultDimensionService(IdentifiableObjectManager idObjectManager,
      PeriodService periodService, AclService aclService,
      CurrentUserService currentUserService, MergeService mergeService, TodoTaskService todoTaskService) {
    checkNotNull(idObjectManager);
//    checkNotNull(categoryService);
    checkNotNull(periodService);
//    checkNotNull(organisationUnitService);
    checkNotNull(todoTaskService);
...
//    this.organisationUnitService = organisationUnitService;
  ...
  public List<DimensionalItemObject> getCanReadDimensionItems(String uid) {
    DimensionalObject dimension = idObjectManager
        .get(DimensionalObject.DYNAMIC_DIMENSION_CLASSES, uid);
...
//    Collection<CategoryOptionGroupSet> cogs = idObjectManager
//        .getDataDimensions(CategoryOptionGroupSet.class);
    Collection<DataElementGroupSet> degs = idObjectManager
        .getDataDimensions(DataElementGroupSet.class);
//    Collection<OrganisationUnitGroupSet> ougs = idObjectManager
...
//
  ...
  public DimensionalObject getDimensionalObjectCopy(String uid, boolean filterCanRead) {
    BaseDimensionalObject dimension = idObjectManager
        .get(DimensionalObject.DYNAMIC_DIMENSION_CLASSES, uid);
  ...
  @Override
  public DimensionalItemObject getDataDimensionalItemObject(IdScheme idScheme,
...
//        else if ((programDataElement = getProgramDataElementDimensionItem(idScheme, id0, id1))
//          != null) {
//        return programDataElement;
//      }
//        else if ((programAttribute = getProgramAttributeDimensionItem(idScheme, id0, id1))
//          != null) {
...
//      }
  ...
  public Set<DimensionalItemObject> getDataDimensionalItemObjects(Set<DimensionalItemId> itemIds) {
    final Map<DimensionalItemId, DimensionalItemObject> map = getDataDimensionalItemObjectMap(
        itemIds);
   ...
   */
  private SetMap<Class<? extends IdentifiableObject>, String> getAtomicIds(
      Set<DimensionalItemId> itemIds) {
...
//          atomicIds.putValue(ProgramIndicator.class, id.getId0());
        ...
        default:
          log.warn("Unrecognized DimensionItemType " + id.getDimensionItemType().name()
              + " in getAtomicIds");
          break;
      }
    }
   ...
   */
  private Map<DimensionalItemId, DimensionalItemObject> getItemObjectMap(
      Set<DimensionalItemId> itemIds,
    ...
    for (DimensionalItemId id : itemIds) {
      ...
      switch (id.getDimensionItemType()) {
        case DATA_ELEMENT:
          DataElement dataElement = (DataElement) atomicObjects
              .getValue(DataElement.class, id.getId0());
          if (dataElement != null) {
...
//              : (CategoryOptionCombo) atomicObjects
//                  .getValue(CategoryOptionCombo.class, id.getId1());
//          CategoryOptionCombo attributeOptionCombo = id.getId2() == null ? null
//              : (CategoryOptionCombo) atomicObjects
//                  .getValue(CategoryOptionCombo.class, id.getId2());
//          if (dataElement != null &&
...
//          }
        ...
        case REPORTING_RATE:
          ...
          if (dataSet != null) {
            dimensionalItemObject = new ReportingRate(dataSet,
                ReportingRateMetric.valueOf(id.getId1()));
          }
          break;
...
//            dimensionalItemObject = new ProgramTrackedEntityAttributeDimensionItem(program,
//                attribute);
//          }
          break;

        case PROGRAM_INDICATOR:
//          ProgramIndicator programIndicator = (ProgramIndicator) atomicObjects
...
//    CategoryOptionCombo categoryOptionCombo = idObjectManager
//        .getObject(CategoryOptionCombo.class, idScheme, categoryOptionComboId);
//    CategoryOptionCombo attributeOptionCombo = idObjectManager
//        .getObject(CategoryOptionCombo.class, idScheme, attributeOptionComboId);
//
//    if (dataElement == null || (categoryOptionCombo == null && !SYMBOL_WILDCARD
//        .equals(categoryOptionComboId))) {
//      return null;
//    }
//
...
//   */
//  private ProgramTrackedEntityAttributeDimensionItem getProgramAttributeDimensionItem(
...
//    TrackedEntityAttribute attribute = idObjectManager
//        .getObject(TrackedEntityAttribute.class, idScheme, attributeId);
//
//    if (program == null || attribute == null) {
//      return null;
//    }
...
//   * @param dataElementId the data element identifier.
//   */
//  private ProgramDataElementDimensionItem getProgramDataElementDimensionItem(IdScheme idScheme,
//      String programId, String dataElementId) {
//    Program program = idObjectManager.getObject(Program.class, idScheme, programId);
//    DataElement dataElement = idObjectManager.getObject(DataElement.class, idScheme, dataElementId);
//
//    if (program == null || dataElement == null) {
...
//   * <p>
//   * Relative periods represented by enums are converted into a RelativePeriods object. User
...
//   */
//  private void mergeDimensionalObjects(BaseAnalyticalObject object,
...
//          groupSetDimension
//              .setDimension(idObjectManager.get(DataElementGroupSet.class, dimensionId));
...
//          groupSetDimension
//              .setDimension(idObjectManager.get(CategoryOptionGroupSet.class, dimensionId));
//          groupSetDimension.getItems()
...
//          attributeDimension
//              .setAttribute(idObjectManager.get(TrackedEntityAttribute.class, dimensionId));
