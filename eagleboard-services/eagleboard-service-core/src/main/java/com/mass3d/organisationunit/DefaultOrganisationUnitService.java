...
import static com.mass3d.commons.util.TextUtils.joinHyphen;
...
import com.mass3d.hierarchy.HierarchyViolationException;
import com.mass3d.organisationunit.comparator.OrganisationUnitLevelComparator;
import com.mass3d.system.filter.OrganisationUnitPolygonCoveringCoordinateFilter;
...
@Service( "com.mass3d.organisationunit.OrganisationUnitService" )
    ...
    OrganisationUnitService
{
    ...
    public List<OrganisationUnit> getOrganisationUnitsAtOrgUnitLevels( Collection<OrganisationUnitLevel> levels,
        Collection<OrganisationUnit> parents )
    {
        return getOrganisationUnitsAtLevels( levels.stream().map( OrganisationUnitLevel::getLevel ).collect( Collectors
                .toList() ),
            parents );
    }
