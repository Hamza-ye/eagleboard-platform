...
public class HibernateOptionGroupStore
  ...
  public HibernateOptionGroupStore(SessionFactory sessionFactory, JdbcTemplate jdbcTemplate,
    ...
    super(sessionFactory, jdbcTemplate, publisher, OptionGroup.class, currentUserService,
        aclService, true);
  }
  ...
  @Override
  public List<OptionGroup> getOptionGroupsNoAcl(DataDimensionType dataDimensionType,
