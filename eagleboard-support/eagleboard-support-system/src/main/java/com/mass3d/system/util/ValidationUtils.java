...
public class ValidationUtils
{
    ...
    private static Set<String> BOOL_FALSE_VARIANTS = Sets
        .newHashSet( "false", "False", "FALSE", "f", "F", "0" );

    private static Set<String> BOOL_TRUE_VARIANTS = Sets
        .newHashSet( "true", "True", "TRUE", "t", "T", "1" );
